...
/**
 * Helper class for the other operations
 *
 * @author Dhruvil Shah
...
public class Helper {
     ...
     * @return If predicate is met at least by one in the Collection, then true
     */
     ...
     * @return List of elements that meet criteria
     */
     ...
     * @param <T> Type parameter
     * @return If inserted into list, true
     */
